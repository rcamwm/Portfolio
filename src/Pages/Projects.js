      ...
      `}>
        ...
        <div className="flex flex-wrap justify-center">
          <ProjectCard 
            ...
            description="I'm currently developing a stagewise speaker verification model. The frontend extracts x-vectors with a Factorized Time-Delay Neural Network architecture. The model is trained with custom Additive Margin Softmax Loss and Ring Loss functions for enhanced speaker discrimination. The backend compares x-vectors with a custom Probabilistic Linear Discriminant Analysis model."
